...
static constexpr auto qt_meta_stringdata_CLASSWeatherENDCLASS = QtMocHelpers::stringData(
    "Weather"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSWeatherENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSWeatherENDCLASS_t qt_meta_stringdata_CLASSWeatherENDCLASS = {
    {
