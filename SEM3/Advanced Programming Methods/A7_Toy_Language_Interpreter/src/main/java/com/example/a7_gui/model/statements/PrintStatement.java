...
public class PrintStatement implements IStatement {
    ...
    @Override
    public ProgramState execute(ProgramState state) throws ExpressionEvaluationException, DataStructureException, DivisionByZero {
        MyIList<Value> out = state.getOutputList();
        out.add(expression.eval(state.getSymbolTable(), state.getHeapTable()));
