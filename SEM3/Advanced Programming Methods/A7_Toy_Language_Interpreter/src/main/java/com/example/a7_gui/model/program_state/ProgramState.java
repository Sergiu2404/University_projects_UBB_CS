...
public class ProgramState {
    ...
    public ProgramState(MyIStack<IStatement> stack, MyISymbolTable<String,Value> symbolTable, MyIList<Value> outputList, MyIFileTable<String, BufferedReader> fileTable, MyIHeap heapTable, IStatement program) {
    ...
    public ProgramState(MyIStack<IStatement> stack, MyISymbolTable<String,Value> symbolTable, MyIList<Value> outputList, MyIFileTable<String, BufferedReader> fileTable, MyIHeap heapTable) {
        this.executionStack = stack;
        this.symbolTable = symbolTable;
        this.outputList = outputList;
        this.fileTable = fileTable;
    ...
    public ProgramState oneStep() throws StatementExecutionException, DataStructureException, ExpressionEvaluationException, StackException, DivisionByZero {
