...
public class ForkStatement implements IStatement{
    ...
    @Override
    public ProgramState execute(ProgramState state) throws StatementExecutionException, ExpressionEvaluationException, DataStructureException {
        ...
        return new ProgramState(newStack, newSymTable, state.getOutputList(), state.getFileTable(), state.getHeapTable());
    }
