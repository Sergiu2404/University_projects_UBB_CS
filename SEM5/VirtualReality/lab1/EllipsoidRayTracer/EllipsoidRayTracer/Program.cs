...
//if set to 0, the intersection detection may incorrectly identify
//intersections that are too close to the light source or surface, causing missing pixels
//offsetting the ray just slightly from the surface point